...
<body>
	...
	<div class="container">
		...
		<div class="myForm">
			<form class="form-horizontal" action="/saveration" method="POST">
				<fieldset>
					<div id="legend">
					...
					<div class="control-group">
						...
						<input type="text" class="form-control" id="packetType"
							name="packetType" value="Food" required="required"
					...
					<div class="control-group">
						...
						<div class="controls">
							<button type="submit"
								...
								class="btn btn-success">AddRation</button>
